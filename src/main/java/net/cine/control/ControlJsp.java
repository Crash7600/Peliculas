...
import net.cine.dao.UsuarioDao;
            ...
            if (ob.equalsIgnoreCase("usuario")) {
                if (op.equalsIgnoreCase("login02")) {
                    ...
                    if (!login.equals("") && !pass.equals("")) {
                        ...
                        /* Este trozo se encarga de poner el tipo de usuario alumno o profesor */
...
//                        }
   ...
   //             || tipoUsuario.equals(net.cine.helper.Enum.TipoUsuario.Usuario)) {
