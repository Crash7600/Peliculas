 ...
 * @author Daniel
 */
public class PeliculaGetpages implements GenericOperation {
    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oPeliculaDAO.getPages(rpp, alFilter, hmOrder);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("PeliculaGetpagesJson: View Error: " + e.getMessage());
        }
    }
}
