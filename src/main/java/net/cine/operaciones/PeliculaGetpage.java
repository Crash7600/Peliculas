 ...
 * @author Daniel
 */
public class PeliculaGetpage implements GenericOperation {
     @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<PeliculaBean> oPeliculas = oPeliculaDAO.getPage(rpp, page, alFilter, hmOrder );
            data = new Gson().toJson(oPeliculas);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
            throw new ServletException("PeliculaGetpageJson: View Error: " + e.getMessage());
        }
    }
}
