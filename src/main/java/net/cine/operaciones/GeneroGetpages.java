 ...
 * @author Daniel
 */
public class GeneroGetpages implements GenericOperation {
 ...
 @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oGeneroDAO.getPages(rpp, alFilter, hmOrder);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("GeneroGetpagesJson: View Error: " + e.getMessage());
        }
    }
}
