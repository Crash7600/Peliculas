 ...
 * @author Diana Ortega
 */
public class GeneroGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<GeneroBean> oGeneros = oGeneroDAO.getPage( rpp, page, alFilter,hmOrder );
            data = new Gson().toJson(oGeneros);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
