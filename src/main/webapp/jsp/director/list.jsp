<%-- 
    ...
    Author     : al037805
--%>
<%@page import="net.cine.helper.Conexion"%>
<%@page import="net.cine.dao.DirectorDao"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.Iterator"%>
<%
    DirectorDao oDirectorDao_Mysql = new DirectorDao(Conexion.getConection());
    ArrayList<String> alColumnsNames = (ArrayList<String>) oDirectorDao_Mysql.getColumnsNames();
        ...
        <div class="row-fluid">
            ...
            <div class="span5">
                <div class="text-right">
                    ...
                    <form class="navbar-form pull-right" action="Controller" method="post" id="directorForm">
                        <fieldset>                                                                     
                            <span>
