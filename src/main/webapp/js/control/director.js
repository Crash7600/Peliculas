...
var control_director_list = function(path) {
    //contexto privado

    var prefijo_div = "#director_list ";
    ...
    function loadModalForm(view, place, id, action) {
        ...
        if (action == "edit") {
            ...
            $(prefijo_div + '#nombre').focus(); /** Esta linea puede dar problemas */
        }
        ...
        $('#formulario').validate({
            ...
            messages: {
                nombredirector: {
                    required: "Ingresa un nombre de un director."
                },
                nacionalidad: {
                    required: "Introduce una nacionalidad"
                },
                anyoinicio: {
