...
var control_estudio_list = function(path) {
    //contexto privado

    var prefijo_div = "#estudio_list ";
        ...
        $('#formulario').validate({
            ...
            messages: {
                ...
                telefono: {
                    ...
                    maxlength: "Tiene que tener 9 digitos"
...
/* Si algo peta y no funciona REVISAR AQUI!!!! 

        var entradaControl = control_estudio_list(path);
        entradaControl.inicia(entradaView, 1, null, null, 10, null, null, null, null, "id_estudio", "equals", id);
        return false;
